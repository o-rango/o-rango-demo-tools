import { Component, h, Element, Event, EventEmitter, ComponentInterface, Prop } from '@stencil/core';
...
export class DemoFabComponent implements ComponentInterface {
  ...
  closeButton() {
    return [
    <button
      data-btn="close-full-screen"
      onClick={() => this.returnPrevious()}
      class="mdc-fab material-icons  mdc-fab--mini app-fab--absolute">
  ...
  render() {
    return this.close ? this.closeButton() : this.deviceSwitchMenu()
  }
}
